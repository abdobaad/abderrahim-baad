...
class BannerSection extends HTMLElement {
  constructor(){
    super();
    this.openMenuButton = this.querySelector('.mobile-menu-button');
    this.MenuModal = this.querySelector('.mobile-menu-container');

    this.openMenuButton.addEventListener('click', this.toggleModal.bind(this, false))
  }

  toggleModal(){
    this.MenuModal.classList.toggle('open')
    if (this.openMenuButton.classList.contains('close')) {
      this.openMenuButton.classList.remove('close')
     this.openMenuButton.classList.add('open') 
    }else{
      this.openMenuButton.classList.remove('open')
     this.openMenuButton.classList.add('close') 
    }
